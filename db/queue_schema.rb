...
ActiveRecord::Schema[8.0].define(version: 20_250_325_023_210) do
  ...
  create_table 'applications', force: :cascade do |t|
    ...
    t.index %w[medical_provider_email status], name: 'index_applications_on_medical_provider_email_and_status'
    ...
    t.index %w[status needs_review_since], name: 'index_applications_on_status_and_needs_review_since'
  ...
  create_table 'applications_products', id: false, force: :cascade do |t|
    ...
    t.index %w[application_id product_id], name: 'index_applications_products_on_application_id_and_product_id'
    t.index %w[product_id application_id], name: 'index_applications_products_on_product_id_and_application_id'
  end
  ...
  create_table 'invoices', force: :cascade do |t|
    ...
    t.index %w[start_date end_date], name: 'index_invoices_on_start_date_and_end_date'
    t.index ['status'], name: 'index_invoices_on_status'
    t.index %w[vendor_id status], name: 'index_invoices_on_vendor_id_and_status'
  ...
  create_table 'proof_reviews', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.text 'notes'
    t.index %w[admin_id created_at], name: 'index_proof_reviews_on_admin_id_and_created_at'
    t.index ['admin_id'], name: 'index_proof_reviews_on_admin_id'
    t.index %w[application_id proof_type created_at],
            name: 'idx_on_application_id_proof_type_created_at_4b8ffa7c5f'
  ...
  create_table 'proof_submission_audits', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[application_id created_at], name: 'idx_proof_audits_app_created'
    ...
    t.index %w[user_id created_at], name: 'idx_proof_audits_user_created'
  ...
  create_table 'role_capabilities', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_id capability], name: 'index_role_capabilities_on_user_id_and_capability', unique: true
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index ['w9_rejections_count'], name: 'index_users_on_w9_rejections_count',
                                     where: "((type)::text = 'Vendor'::text)"
  ...
  create_table 'voucher_transaction_products', force: :cascade do |t|
    ...
    t.index %w[voucher_transaction_id product_id], name: 'idx_on_voucher_txn_product'
  ...
  create_table 'voucher_transactions', force: :cascade do |t|
    ...
    t.index %w[vendor_id status], name: 'index_voucher_transactions_on_vendor_id_and_status'
    t.index ['vendor_id'], name: 'index_voucher_transactions_on_vendor_id'
    t.index %w[voucher_id transaction_type], name: 'index_voucher_transactions_on_voucher_id_and_transaction_type'
  ...
  create_table 'vouchers', force: :cascade do |t|
    ...
    t.index %w[vendor_id status], name: 'index_vouchers_on_vendor_id_and_status'

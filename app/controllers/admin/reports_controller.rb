...
module Admin
  class ReportsController < Admin::BaseController
    ...
    def load_quick_reports_data
      ...
      @current_fy_draft_applications = Application.where(status: :draft,
                                                         created_at: @current_fy_start..@current_fy_end).count
      @previous_fy_draft_applications = Application.where(status: :draft,
      ...
      # Unredeemed vouchers
      @current_fy_unredeemed_vouchers = Voucher.where(created_at: @current_fy_start..@current_fy_end,
                                                      status: :active).count
      @previous_fy_unredeemed_vouchers = Voucher.where(created_at: @previous_fy_start..@previous_fy_end,
                                                       status: :active).count
      ...
      @mfr_applications_approved = Application.where(created_at: @previous_fy_start..@previous_fy_end,

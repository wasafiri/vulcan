...
namespace :letters do
  ...
  task check_email_letter_consistency: :environment do
    ...
    missing_letters = email_templates.reject { |template| letter_templates.include?(template) }
    ...
    mailer_classes.each do |mailer_class|
      ...
      mailer_methods.each do |method|
        ...
        missing_letter_methods << "#{mailer_class.name}##{method_name}" unless letter_types.include?(method_name)
      end
    end

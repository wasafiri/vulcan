...
module TestBrowsers
  class Downloader
    ...
    def self.ensure_binaries!
      ...
      raise 'Failed to download Chrome for Testing binaries. Check paths and permissions.' unless binaries_exist?
          ...
          when Net::HTTPSuccess
            ...
            File.open(path, 'wb') do |file|
              response.read_body do |chunk|
                ...
                print "\rDownloading: #{(downloaded_size.to_f / total_size * 100).round(1)}% " if total_size.positive?
              end
            end
    ...
    def self.make_executable(path)
      ...
      File.chmod(0o755, path) # rwxr-xr-x permissions
    end
  end
end

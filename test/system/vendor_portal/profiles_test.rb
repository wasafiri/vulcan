  ...
  class ProfilesTest < ApplicationSystemTestCase
    ...
    test 'updating a Vendor profile and accepting terms' do
      ...
      if current_path == sign_in_path
        # If we're back at sign-in, skip this test since authentication is failing
      ...
      # Clear and fill the business name field
      ...
      check 'I agree to the vendor terms and conditions' if has_field?('I agree to the vendor terms and conditions')

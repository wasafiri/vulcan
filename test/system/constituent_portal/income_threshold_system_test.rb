...
module ConstituentPortal
  class IncomeThresholdSystemTest < ApplicationSystemTestCase
    ...
    test "income threshold calculation in JavaScript matches server calculation" do
      ...
      test_cases = [
        { household_size: 1, income: 59999, expected_disabled: false }, # Below threshold
        { household_size: 1, income: 60001, expected_disabled: true },  # Above threshold
        { household_size: 3, income: 99999, expected_disabled: false }, # Below threshold
        { household_size: 3, income: 100001, expected_disabled: true }, # Above threshold
        { household_size: 8, income: 199999, expected_disabled: false }, # Below threshold
        { household_size: 8, income: 200001, expected_disabled: true }  # Above threshold
      ]
    ...
    test "income threshold calculation is accurate for edge cases" do
      ...
      fill_in "Annual Income", with: 100000 # Exactly at the threshold (25000 * 4)
      ...
      fill_in "Annual Income", with: 199999 # Below the threshold for size 8 (50000 * 4)
      find("body").click # Trigger blur event
      sleep 0.5
      ...
      fill_in "Annual Income", with: 1000000 # Well above the threshold
      find("body").click # Trigger blur event
      sleep 0.5

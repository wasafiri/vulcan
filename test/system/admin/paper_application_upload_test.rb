...
class Admin::PaperApplicationUploadTest < ApplicationSystemTestCase
  setup do
  ...
  test "switching between accept and reject modes properly manages state" do
    ...
    assert find("input[name='income_proof']", visible: false).disabled?, "Income proof file input should be disabled when reject is selected"
    
    # Then for residency proof
    find("input[id='reject_residency_proof']").click
    assert find("input[name='residency_proof']", visible: false).disabled?, "Residency proof file input should be disabled when reject is selected"
    
    # Test file input enabling when accept is selected
    find("input[id='accept_income_proof']").click
    assert_not find("input[name='income_proof']", visible: false).disabled?, "Income proof file input should be enabled when accept is selected"

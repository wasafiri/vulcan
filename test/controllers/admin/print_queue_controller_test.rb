...
class Admin::PrintQueueControllerTest < ActionDispatch::IntegrationTest
  def setup
  ...
  def test_should_download_multiple_letters_as_zip
    ...
    Tempfile.stub :new, mock_zipfile do
      File.stub :exist?, true do
        get download_batch_admin_print_queue_index_path, params: { letter_ids: [@pending_letter.id, @pending_letter2.id] }
        assert_response :success

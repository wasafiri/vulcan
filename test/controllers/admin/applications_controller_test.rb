...
module Admin
  class ApplicationsControllerTest < ActionDispatch::IntegrationTest
    ...
    test 'show page displays the correct proof review button text' do
      ...
      puts "DEBUG: Response body contains: #{response.body.scan(/data-proof-type="income".*?>(.*?)<\/button>/m).flatten.first}"
      ...
      puts "DEBUG: Rejected response body contains: #{response.body.scan(/data-proof-type="income".*?>(.*?)<\/button>/m).flatten.first}"
